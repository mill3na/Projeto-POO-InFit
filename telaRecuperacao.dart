        ...
        child: ListView(
          children: [
            CircleAvatar( // circulo de terá o icone de cadeado representando a segurança de trocar a senha
              radius: 100,
              child: Icon(Icons.privacy_tip, size: 80), foregroundColor: Color(corFundo), // adicionando icone
            ...
            Container(
              child: Column( // coluna para organizar as caixas de texto mais facilmente
                ...
                children: [
                  ...
                  pularLinha(20),
                  preenchimentoUsuario("E-mail", TextInputType.emailAddress, Icon(Icons.privacy_tip)), // caixa de texto do usuário de email
                  pularLinha(40),
