          ...
          children: [
            ...
            Container(
              child: Column( // coluna para organizar as caixas de texto mais facilmente
                ...
                children: [
                  preenchimentoUsuario("texto generico", TextInputType.text, Icon(Icons.password, color: Color(corPrimaria),)), // caixa de texto genérica
                  pularLinha(20),
                  preenchimentoUsuario("texto generico", TextInputType.text, Icon(Icons.password, color: Color(corPrimaria),)),
                  pularLinha(20),
                  preenchimentoUsuario("texto generico", TextInputType.text, Icon(Icons.password, color: Color(corPrimaria),)),
                  pularLinha(20),
                  preenchimentoUsuario("texto generico", TextInputType.text, Icon(Icons.password, color: Color(corPrimaria),)),
